    ...
    <div className="aboutus-container">
        ...
        <div className="branches-container">
            ...
            <div className="branches-content">
                ...
                <a href="https://goo.gl/maps/hJKhWGTQ1Zit1vK3A" target="_blank" rel="noopener noreferrer">
                    <button> ORLENALYCIOUS <br /> Panjer</button>
                </a>
            </div>
            <div className="branches-content">
                <img src={branchLivingWorld} alt="Branch Living World" />
                <a href="https://goo.gl/maps/4bEN1Ev8ELPt1Kst7" target="_blank" rel="noopener noreferrer">
                    <button> ORLENALYCIOUS <br /> Living World</button>
                </a>
            </div>
            <div className="branches-content">
                <img src={branchIconMall} alt="Branch Icon Mall" />
                <a href="https://goo.gl/maps/W3vwohrtYJ3uVucdA" target="_blank" rel="noopener noreferrer">
                    <button> ORLENALYCIOUS <br /> Icon Mall</button>
                </a>
            </div>
            <div className="branches-content">
                <img src={branchAkasia} alt="Branch Akasia" />
                <a href="https://goo.gl/maps/7AdeP7waHXRpczCp6" target="_blank" rel="noopener noreferrer">
                    <button> ORLENALYCIOUS <br /> Akasia</button>
                </a>
            </div>
        </div>
